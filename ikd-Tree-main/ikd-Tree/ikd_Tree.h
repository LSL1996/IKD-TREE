...
public:
    ...
    struct KD_TREE_NODE{
        ...
        pthread_mutex_t push_down_mutex_lock;  // pthread_mutex_t:线程互斥量
...
private:
    ...
    pthread_t rebuild_thread;  // pthread_t:多线程是实现多任务处理的一种最常用的手段，线程相比进程而言显得轻量级
    ...
    MANUAL_Q<Operation_Logger_Type> Rebuild_Logger;   // 包含了各种操作  
